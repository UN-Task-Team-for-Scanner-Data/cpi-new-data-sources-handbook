...
+---------------------+--------------------------------------------------------------------------------------------+
| Page History        | [See here](https://unstats.un.org/wiki/pages/viewpreviousversions.action?pageId=240910480) |
+---------------------+--------------------------------------------------------------------------------------------+
...
For products identified as outliers it may be appropriate to consider [imputation](treatment-of-missing-prices.qmd). For those products filtered out by the dumping or low sales filter, these should not be imputed. 

Since web scraping data comprise of information only on prices but not sales quantities, the dumping filter and low sales filter cannot be applied in the typical manner. However, there is currently ongoing research into methods to [estimate the expenditure shares of web scraped articles](https://unstats.un.org/wiki/display/GWGSD/Deriving+proxy+weights+for+web+scraped+data).
